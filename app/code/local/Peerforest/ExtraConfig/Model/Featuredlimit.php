<?php class Peerforest_ExtraConfig_Model_Featuredlimit
{
    public function toOptionArray()
    {
        return array(
             array('value'=>'5', 'label'=>Mage::helper('ExtraConfig')->__('5')),
            array('value'=>'8', 'label'=>Mage::helper('ExtraConfig')->__('8')),
            ...
            array('value'=>'60', 'label'=>Mage::helper('ExtraConfig')->__('60')),
            array('value'=>'70', 'label'=>Mage::helper('ExtraConfig')->__('70')),
            array('value'=>'80', 'label'=>Mage::helper('ExtraConfig')->__('80')),
            array('value'=>'90', 'label'=>Mage::helper('ExtraConfig')->__('90')),
            array('value'=>'100', 'label'=>Mage::helper('ExtraConfig')->__('100'))
        );
    }
